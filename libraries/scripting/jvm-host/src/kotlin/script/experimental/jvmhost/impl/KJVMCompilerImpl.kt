...
class KJVMCompiledScript<out ScriptBase : Any>(
    ...
    override suspend fun instantiate(scriptEvaluationEnvironment: ScriptEvaluationEnvironment): ResultWithDiagnostics<ScriptBase> = try {
        val baseClassLoader = scriptEvaluationEnvironment.getOptional(JvmScriptEvaluationEnvironmentParams.baseClassLoader)
        val dependencies = configuration.getOptional(ScriptCompileConfigurationParams.dependencies)
    ...
    override fun compile(
        ...
        try {
            ...
            fun updateClasspath(classpath: Iterable<File>) {
                ...
                val updatedDeps = updatedScriptCompileConfiguration.getOptional(ScriptCompileConfigurationParams.dependencies)?.plus(
            ...
            val kotlinCompilerConfiguration = org.jetbrains.kotlin.config.CompilerConfiguration().apply {
                ...
                scriptCompilerConfiguration.getOptional(ScriptCompileConfigurationParams.dependencies)?.let {
