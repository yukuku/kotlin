 ...
 *
 * @param D the type of the first receiver (the dispatch receiver). In case of the extension property in a class this is
 *        the type of the declaring class of the property, or any subclass of that class.
 * @param E the type of the second receiver (the extension receiver). In case of the extension property in a class this is
...
public interface KProperty2<D, E, out R> : KProperty<R>, (D, E) -> R {
     ...
     * Getter of the property is a `get` method declared alongside the property.
     *
     * Can be used as a function that takes an argument of type [D] (the dispatch receiver), an argument of type [E] (the extension receiver)
